...
import './NewSuperviseurShoop.css'
import { motion } from "framer-motion"
import axios from 'axios'

const NewSuperviseurShoop = ({handleClose}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error('Error adding superviseurShoop:', error);
        }
    };
...
export default NewSuperviseurShoop
