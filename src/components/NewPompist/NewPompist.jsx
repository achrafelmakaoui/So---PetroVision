...
import './NewPompist.css'
import { motion } from "framer-motion"
import axios from 'axios'

const NewPomist = ({handleClose}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error('Error adding pompist:', error);
        }
    };
                                ...
                                <div className='contentNewClientKey'>
                                    ...
                                    <div className='addClientBannerForm'>
                                        ...
                                        <div className='addClientInputs'>
                                            ...
                                            <div className='InputsClm1'>
                                                <label>Shift</label>
                                                <input type='text' placeholder="Entrer shift" value={shift} onChange={(e) => setShift(e.target.value)} required/>
                                            </div>
                                        </div>
                                        <div className='addClientInputs'>
                                            <div className='InputsClm1'>
